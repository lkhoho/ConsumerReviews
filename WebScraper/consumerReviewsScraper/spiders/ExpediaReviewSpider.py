...
class ExpediaReviewSpider(Spider):
    ...
    start_urls = [
        'https://www.expedia.com/Tokyo-Hotels-Daiichi-Hotel-Tokyo-Seafort.h54207.Hotel-Information?chkin=9%2F28%2F2019&chkout=9%2F29%2F2019&regionId=179165&destination=Shinagawa%2C+Tokyo%2C+Japan&swpToggleOn=true&rm1=a2&x_pwa=1&price=0%2C300&sort=recommended&lodging=ryoken&top_dp=154&top_cur=USD&rfrr=HSR&pwa_ts=1569187236031',
    ]
    ...
    def start_requests(self):
        for url in self.start_urls:
            ...
            yield Request(url=url, callback=self.parse_hotel, meta={'property_ID': property_ID},
                          headers={
