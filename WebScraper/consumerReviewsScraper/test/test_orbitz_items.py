...
class TestOrbitzReviewItem(unittest.TestCase):
    ...
    def test_upsert(self):
        obj = OrbitzReviewItem(review_id=self.test_data[0], company_id=self.test_data[1], company=self.test_data[2],
    ...
    def _insert(self, obj: OrbitzReviewItem) -> None:
        self.conn.execute('INSERT INTO orbitz_review(`review_id`, `company`, `company_id`, `category`, `content`, '
...
def create_test_suite() -> unittest.TestSuite:
    ...
    suite.addTests([
        TestOrbitzReviewItem('test_upsert_delete'),
    ])
    return suite
